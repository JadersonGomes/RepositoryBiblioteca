...
namespace AspImpactaBiblioteca.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            // Configuração do contexto. A Injeção de Dependencia é configurada para ser utilizada apenas o mesmo contexto para todas.
            kernel.Bind<BibliotecaContext>().ToSelf().InRequestScope();

            // Mostrando para o Ninject quais são as classes respectivas para cada Interface, para que o mesmo crie uma instancia da classe concreta
            ...
            // Classe SEPARADA das responsáveis pelo CRUD e Controllers(Autor, Categoria e etc).
